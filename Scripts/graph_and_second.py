...
def make_graph(x_df,y_df):
    ...
    Args:
        x_df ([pd.DataFrame]): [x座標のデータフレーム]
        y_df ([pd.DataFrame]): [y座標のデータフレーム]
...
if __name__ == "__main__":
    ...
    #かかった秒数を列として追加
    replace_second(squat1_x_df,squat1_y_df)
    replace_second(squat2_x_df,squat2_y_df)